  ...
  const printPdf = useCallback(async (
    ...
    try {
      ...
      const pagedStyles = `
        ...
        .pagedjs_page_content, .pagedjs_page .prose-preview {
          ${cssVarString}
          width: 100%;
          max-width: 100%;
        ...
        :is(.prose-preview, .pagedjs_page_content) input[type="checkbox"]:checked { background-color: ${accentColor}; border-color: ${accentColor}; }
